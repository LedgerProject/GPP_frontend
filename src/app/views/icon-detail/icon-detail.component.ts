          ...
          switch (code) {
            case 400:
              this.showErrorMessage(
                this.translate.instant('Error uploading icon'),
                this.translate.instant('Please check that image file is 48x48 pixels, and marker file is 32x37 pixels.')
              );
              break;
      ...
      .subscribe(data => {
        ...
        switch (code) {
          case 400:
            this.showErrorMessage(
              this.translate.instant('Error uploading icon'),
              this.translate.instant('Please check that image file is 48x48 pixels.')
            );
            break;
